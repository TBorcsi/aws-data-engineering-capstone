...
![TASK 1 – Cloud9 environment + S3 buckets (page 2)](images/page-02.png)
...
![TASK 2 – head command + Glue database/crawler setup (page 4)](images/page-04.png)
...
![TASK 2 – crawler run + Athena output configuration (page 5)](images/page-05.png)
...
![Athena challenge prompt + results screenshot (page 6)](images/page-06.png)
...
![Challenge SQL + results screenshots (page 7)](images/page-07.png)
...
![TASK 3 – upload + crawler rerun + query editor (page 9)](images/page-09.png)
...
![Fiji EEZ query + results (page 10)](images/page-10.png)
...
![Open seas query + results (page 11)](images/page-11.png)
...
![Combined EEZ + open seas query + results (page 12)](images/page-12.png)
...
![Create view + mackerel query (page 13)](images/page-13.png)

![Mackerel query results (page 14)](images/page-14.png)
...
![Mackerel results screenshot (page 15)](images/page-15.png)
...
![China mackerel query + results (page 16)](images/page-16.png)
...
![Query 1 screenshot (page 17)](images/page-17.png)
...
![Query 2 screenshot (page 18)](images/page-18.png)
...
![Query 3 screenshot (page 19)](images/page-19.png)
